...
try{
const luser=await db.query(`select id,name,role,verif,items, w_items,model,bstatus,buser_d  from busers where id=$1`,[id])
...
loc_fb = "http://example.com/auth/facebook/callback";	
}
